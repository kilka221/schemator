...
**СХЕМАТОР** — это удобный веб-сервис, который автоматически анализирует исходный код на **Python** и **C++** и строит по нему наглядные алгоритмические блок-схемы. 
...
[Запустить ссылку](https://schemator.ru/)
